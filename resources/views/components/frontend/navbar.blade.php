            ...
            <ul class="flex flex-col mr-auto list-none lg:flex-row">
                <li class="flex items-center">
                    <a class="flex items-center px-3 py-4 text-xs font-bold uppercase lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 lg:py-2"
                        href="https://www.creative-tim.com/learning-lab/tailwind/js/overview/notus?ref=njs-landing"><i
                            class="mr-2 text-lg lg:text-blueGray-200 text-blueGray-400 far fa-file-alt leading-lg"></i>
                        Docs</a>
                </li>
            </ul>
            <ul class="flex flex-col items-center list-none lg:flex-row lg:ml-auto">
                ...
                <li class="flex items-center">
                    <a class="flex items-center px-3 py-4 text-xs font-bold uppercase lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 lg:py-2"
                        ...
                        target="_blank"><i
                            class="text-lg lg:text-blueGray-200 text-blueGray-400 fab fa-facebook leading-lg"></i><span
                            class="inline-block ml-2 lg:hidden">Share</span></a>
                </li>
                <li class="flex items-center">
                    <a class="flex items-center px-3 py-4 text-xs font-bold uppercase lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 lg:py-2"
                        ...
                        target="_blank"><i
                            class="text-lg lg:text-blueGray-200 text-blueGray-400 fab fa-twitter leading-lg"></i><span
                            class="inline-block ml-2 lg:hidden">Tweet</span></a>
                </li>
                <li class="flex items-center">
                    <a class="flex items-center px-3 py-4 text-xs font-bold uppercase lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 lg:py-2"
                        href="https://github.com/creativetimofficial/notus-js?ref=njs-landing"
                        target="_blank"><i
                            class="text-lg lg:text-blueGray-200 text-blueGray-400 fab fa-github leading-lg"></i><span
                            class="inline-block ml-2 lg:hidden">Star</span></a>
                </li>
                <li class="flex items-center">
                    <button
