<x-guest-user-layout>
    <div class="relative flex items-center content-center justify-center pt-16 pb-32 min-h-screen-75">
        <div class="absolute top-0 w-full h-full bg-center bg-cover"
          ...
          ">
            <span id="blackOverlay"
                class="absolute w-full h-full bg-black opacity-75"></span>
        </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 top-auto w-full overflow-hidden pointer-events-none h-70-px"
            ...
            <svg class="absolute bottom-0 overflow-hidden"
                ...
                x="0"
                y="0">
                <polygon class="fill-current text-blueGray-200"
        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="flex flex-wrap items-center mt-32">
                <div class="w-full px-4 ml-auto mr-auto md:w-5/12">
                    ...
                    <p class="mt-4 mb-4 text-lg font-light leading-relaxed text-blueGray-600">
                        Don't let your uses guess by attaching tooltips and popoves to
                        any element. Just make sure you enable them first via
                        JavaScript.
                    </p>
                    <p class="mt-0 mb-4 text-lg font-light leading-relaxed text-blueGray-600">
                ...
                <div class="w-full px-4 ml-auto mr-auto md:w-4/12">
                    <div
                        class="relative flex flex-col w-full min-w-0 mb-6 break-words bg-pink-500 rounded-lg shadow-lg">
                        <img alt="..."
                        ...
                        <blockquote class="relative p-8 mb-4">
                            <svg preserveAspectRatio="none"
                                ...
                                <polygon points="-30,95 583,95 583,65"
                                    class="text-pink-500 fill-current"></polygon>
                            </svg>
    ...
    <section class="relative py-20">
        <div class="absolute top-0 left-0 right-0 bottom-auto w-full h-20 -mt-20 overflow-hidden pointer-events-none"
            style="transform: translateZ(0px)">
            <svg class="absolute bottom-0 overflow-hidden"
                xmlns="http://www.w3.org/2000/svg"
                preserveAspectRatio="none"
                ...
                <div class="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                    <div class="px-6">
                        ...
                        <div class="pt-6 text-center">
                            ...
                            <p class="mt-1 text-sm font-semibold uppercase text-blueGray-400">
                                Web Developer
                            </p>
                            <div class="mt-6">
                                <button
    ...
    <section class="relative block pb-20 bg-blueGray-800">
        <div class="absolute top-0 left-0 right-0 bottom-auto w-full h-20 -mt-20 overflow-hidden pointer-events-none"
            ...
            <svg class="absolute bottom-0 overflow-hidden"
                ...
                x="0"
                y="0">
                <polygon class="fill-current text-blueGray-800"
                    points="2560 0 2560 100 0 100"></polygon>
            </svg>
        </div>
                ...
                <div class="w-full px-4 lg:w-6/12">
                    <div
                        ...
                        <div class="flex-auto p-5 lg:p-10">
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block mb-2 text-xs font-bold uppercase text-blueGray-600"
                                    for="message">Message</label><textarea rows="4"
                                    cols="80"
